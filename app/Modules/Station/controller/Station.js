console.log('fasdf')
Ext.namespace(moduleConfig.appName+'.'+ controller +'.controller'); 
Ext.define(moduleConfig.appName+'.Modules.'+controller+'.controller.'+controller, {
    extend: moduleConfig.appName+'.controller.Core',
    models: [
