        ...
        this.control(
            {
                 ...
                 * Clear filters
                 */
                'AliasGridGridFilter button[action=clearFilters]': {
                    click: this.clearFilters
                },
                'AliasGridGridFilter button[action=clearFilter]': {
                    click: this.clearFilter
                },
                'AliasGridGridList button[action=clearFilter]': {
                    click: this.clearFilter
                },
                /**
                 * Filters
                ...
                'AliasGridGridFilter combo[id=GridGridFilterName]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasGridGridFilter combo[id=GridGridFilterAction]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasGridGridFilter combo[id=columnas2]': {
                    select: this.columnSelect
                },
                'AliasGridGridFilter numberfield[id=value1]': {
                    keyup: this.validateValue1
                },
                'AliasGridGridFilter numberfield[id=valueRange1]': {
                    keyup: this.validateRange
                },
                'AliasGridGridFilter numberfield[id=valueRange2]': {
                    keyup: this.validateRange
                },
                'AliasGridGridFilter checkbox[id=allEstratos]': {
                ...
                '#map': {
                    click: this.biuldGridGrid
                },

                'AliasGridGridFilter combo[id=GridGridFilterSection]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasGridGridFilter datefield[id=GridGridFilterStart]': {
                    change: this.SelectFilterDateStart
                },
                'AliasGridGridFilter datefield[id=GridGridFilterEnd]': {
                    change: this.SelectFilterDateEnd
                },
                'AliasGridGridFilter checkbox[id=GridGridFilterDeleted]': {
                 ...
                 * Excel
                 */
                'AliasGridGridList button[action=exportXls]': {
                    click: this.exportxls
                },
                'AliasGridGridList button[action=GridGridListCreate]': {
                    click: this.exportxls
                }
            }
        );
...
//         storeConn.reload();
    ...
    multiSearch: function () {
         ...
         * Get Store
         */
//        var store = this.getGridGridListStore();
//
//        /**
//         * field search
//         */
...
//        jsonObj.func = moduleConfig.serviceGridGridList;
//        jsonObj.filter = [];
//
//        if (name !='') {
//            jsonObj.filter.push(
...
//                                              + lonlat.lon + " E");
        ...
        var map = new OpenLayers.GridGrid({
                controls: [
...
//            );
            ...
            mappanel = Ext.create('GeoExt.panel.GridGrid', {
...
//        var obj = this;
//        this.loadScript('app/controller/GridGrid.js',function(){
//
//            obj.loadComponent('GridGrid')
//        })
