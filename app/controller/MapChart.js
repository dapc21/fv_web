        ...
        this.control(
            {
                 ...
                 * Clear filters
                 */
                'AliasMapMixFilter button[action=clearFilters]': {
                    click: this.clearFilters
                },
                'AliasMapMixFilter button[action=clearFilter]': {
                    click: this.clearFilter
                },
                'AliasMapMixList button[action=clearFilter]': {
                    click: this.clearFilter
                },
                /**
                 * Filters
                ...
                'AliasMapMixFilter combo[id=MapMixFilterName]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasMapMixFilter combo[id=MapMixFilterAction]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasMapMixFilter combo[id=columnas2]': {
                    select: this.columnSelect
                },
                'AliasMapMixFilter numberfield[id=value1]': {
                    keyup: this.validateValue1
                },
                'AliasMapMixFilter numberfield[id=valueRange1]': {
                    keyup: this.validateRange
                },
                'AliasMapMixFilter numberfield[id=valueRange2]': {
                    keyup: this.validateRange
                },
                'AliasMapMixFilter checkbox[id=allEstratos]': {
                ...
                '#map': {
                    click: this.biuldMapMix
                },
                
                'AliasMapMixFilter combo[id=MapMixFilterSection]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasMapMixFilter datefield[id=MapMixFilterStart]': {
                    change: this.SelectFilterDateStart
                },
                'AliasMapMixFilter datefield[id=MapMixFilterEnd]': {
                    change: this.SelectFilterDateEnd
                },
                'AliasMapMixFilter checkbox[id=MapMixFilterDeleted]': {
                 ...
                 * Excel
                 */
                'AliasMapMixList button[action=exportXls]': {
                    click: this.exportxls
                },
                'AliasMapMixList button[action=MapMixListCreate]': {
                    click: this.exportxls
                }
            }
        );
...
//         storeConn.reload();  
    ...
    multiSearch: function () {
         ...
         * Get Store
         */
//        var store = this.getMapMixListStore();
//
//        /**
//         * field search
//         */
...
//        jsonObj.func = moduleConfig.serviceMapMixList;
//        jsonObj.filter = [];
//        
//        if (name !='') {
//            jsonObj.filter.push(
...
//            );
            ...
            mappanel = Ext.create('GeoExt.panel.MapMix', {
...
//        var obj = this;
//        this.loadScript('app/controller/MapMix.js',function(){
//            
//            obj.loadComponent('MapMix')
//        })
