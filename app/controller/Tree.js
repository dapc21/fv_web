        ...
        this.control(
            {
                 ...
                 * Clear filters
                 */
                'AliasTreeFilter button[action=clearFilters]': {
                    click: this.clearFilters
                },
                'AliasTreeFilter button[action=clearFilter]': {
                    click: this.clearFilter
                },
                'AliasTreeList button[action=clearFilter]': {
                    click: this.clearFilter
                },
                /**
                 * Filters
                ...
                'AliasTreeFilter combo[id=TreeFilterName]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasTreeFilter combo[id=TreeFilterAction]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasTreeFilter combo[id=columnas2]': {
                    select: this.columnSelect
                },
                'AliasTreeFilter numberfield[id=value1]': {
                    keyup: this.validateValue1
                },
                'AliasTreeFilter numberfield[id=valueRange1]': {
                    keyup: this.validateRange
                },
                'AliasTreeFilter numberfield[id=valueRange2]': {
                    keyup: this.validateRange
                },
                'AliasTreeFilter checkbox[id=allEstratos]': {
                ...
                '#map': {
                    click: this.biuldTree
                },
                
                'AliasTreeFilter combo[id=TreeFilterSection]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasTreeFilter datefield[id=TreeFilterStart]': {
                    change: this.SelectFilterDateStart
                },
                'AliasTreeFilter datefield[id=TreeFilterEnd]': {
                    change: this.SelectFilterDateEnd
                },
                'AliasTreeFilter checkbox[id=TreeFilterDeleted]': {
                 ...
                 * Excel
                 */
                'AliasTreeList button[action=exportXls]': {
                    click: this.exportxls
                },
                'AliasTreeList button[action=TreeListCreate]': {
                    click: this.exportxls
                }
            }
        );
...
//         storeConn.reload();  
    ...
    multiSearch: function () {
         ...
         * Get Store
         */
//        var store = this.getTreeListStore();
//
//        /**
//         * field search
//         */
...
//        jsonObj.func = moduleConfig.serviceTreeList;
//        jsonObj.filter = [];
//        
//        if (name !='') {
//            jsonObj.filter.push(
...
//            );
            ...
            mappanel = Ext.create('GeoExt.panel.Tree', {
...
//        var obj = this;
//        this.loadScript('app/controller/Tree.js',function(){
//            
//            obj.loadComponent('Tree')
//        })
