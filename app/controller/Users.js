...
Ext.define('LoadPrincipal.controller.' + controller, {
    ...
    models: [
        'Resources.List',
        'Resources.ListComboDevices',
        'Resources.ListComboResources',
        'Resources.ListComboApplication',
        'Resources.ListComboRoles',
        'Resources.ListRoles',
        'Resources.ListResources',
        'Resources.ListDevices',
        'Resources.ListResourceGroups',
        'Resources.ListRestore'
    ],
    stores: [
        'Resources.List',
        'Resources.ListComboDevices',
                            ...
                            ******************************************************************/
                            ...
                            if (devDefinitions.length > 0) {
                                for (var dvDef=0; dvDef < devDefinitions.length; dvDef++) {
                                    ...
                                    if (dvDef == (devDefinitions.length-1)) {
                                        filterOrDevDef += '{"field" : "_id","comparison" : "eq","value" : "'+devDefinitions[dvDef]+'"}';
                                    } else {
                                        filterOrDevDef += '{"field" : "_id","comparison" : "eq","value" : "'+devDefinitions[dvDef]+'"},';
                                    }
                                }
                                        ...
                                        items       : [
                                            {
                                                ...
                                                store             : Ext.create('Ext.data.Store', {
                                                    ...
                                                    model      : Ext.define('LoadPrincipal.model.Resources.ListComboDevicesType', {
                                                        ...
                                                        fields     : [
                                                            {name : '_id', mapping: 'id_deviceDefinition', type: 'string'},
                                                            {name : 'name', mapping: 'deviceDefinitionName', type: 'string'}
                                                        ],
                                                        idProperty : '_id'
                                                    }),
                                                    autoLoad   : false,
                            ...
                            moduleConfig.tab[i].gridResourcesGroupForm = [
                                {
                                    ...
                                    store       : 'Resources.ListResourceGroups',
                                    loadMask    : true,
                                    autoHeight  : true,
                                    multiSelect : true,
                                    selType     : 'checkboxmodel',
                            ...
                            moduleConfig.tab[i].gridPanelGroup.store = Ext.create('Ext.data.Store', {
                                ...
                                proxy      : {
                                    ...
                                    method              : 'GET',
                                    useDefaultXhrHeader : false,
                                    url                 : moduleConfig.services.listGroupUrl+'?filters={"and":[{"field":"id_resourceDefinition","comparison":"eq","value":"'+data[i]._id+'"}]}',
                                    reader              : {
                                        type            : 'json',
                                        root            : 'data',
                                        totalProperty   : 'pagination.total',
                                    ...
                                    menu    : [
                                        {
                                            ...
                                            action  : controller + 'Active'+groupId,
                                            iconCls : 'unlock-menu',
                                            handler : function() {
                                                var tabPanel = this.up('tabpanel');
                                                var activeItem = tabPanel.getActiveTab();
                                                    ...
                                                    for (var i = 0, len = selectedRecords.length; i < len; i++) {
                                                        ...
                                                        Ext.Ajax.request({
                                                            ...
                                                            success  : function(response){
                                                                msgWait.hide();
                                                                Ext.MessageBox.show({
                                                                    title   : translate.global.active+' '+translateresources.moduleTitle,
                                                                    msg     : translateresources.form.MsgSuccessActivatePlural,
                                                                    buttons : Ext.MessageBox.OK,
                                                                    icon    : Ext.MessageBox.INFO
                                                                });
                                                                Ext.data.StoreManager.lookup(moduleConfig.tab[activeIndex].gridPanel.store).reload();
                                        ...
                                        },
                                        {
                                            ...
                                            action  : controller + 'Inactive'+groupId,
                                            iconCls : 'lock-menu',
                                            handler : function() {
                                                var tabPanel = this.up('tabpanel');
                                                var activeItem = tabPanel.getActiveTab();
                                                    ...
                                                    for (var i = 0, len = selectedRecords.length; i < len; i++) {
                                                        ...
                                                        Ext.Ajax.request({
                                                            ...
                                                            success  : function(response){
                                                                msgWait.hide();
                                                                Ext.MessageBox.show({
                                                                    title   : translate.global.suspend+' '+translateresources.moduleTitle,
                                                                    msg     : translateresources.form.MsgSuccessSuspendPlural,
                                                                    buttons : Ext.MessageBox.OK,
                                                                    icon    : Ext.MessageBox.INFO
                                                                });
                                                                Ext.data.StoreManager.lookup(moduleConfig.tab[activeIndex].gridPanel.store).reload();
                                                        ...
                                                        handler : function() {
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success  : function(response) {
                                                                    ...
                                                                    Ext.MessageBox.show({
                                                                        title   : translate.global.active+' '+translateresources.moduleTitle,
                                                                        msg     : translateresources.form.MsgSuccessActivate,
                                                                        buttons : Ext.MessageBox.OK,
                                                                        icon    : Ext.MessageBox.INFO
                                                                    });
                                                                    var grid = record.up('grid');
                                                        ...
                                                        handler : function() {
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success  : function(response) {
                                                                    msgWait.hide();
                                                                    Ext.MessageBox.show({
                                                                        title   : translate.global.inactive+' '+translateresources.moduleTitle,
                                                                        msg     : translateresources.form.MsgSuccessSuspend,
                                                                        buttons : Ext.MessageBox.OK,
                                                                        icon    : Ext.MessageBox.INFO
                                                                    });
                                                                    var grid = record.up('grid');
                                        ...
                                        items       : [
                                            {
                                                ...
                                                toggleHandler: function (btn, pressed) 
                                                {
                                                    console.log('Exportar archivo excel.');
