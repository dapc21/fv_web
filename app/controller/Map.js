        ...
        this.control(
            {
                 ...
                 * Clear filters
                 */
                'AliasMapFilter button[action=clearFilters]': {
                    click: this.clearFilters
                },
                'AliasMapFilter button[action=clearFilter]': {
                    click: this.clearFilter
                },
                'AliasMapList button[action=clearFilter]': {
                    click: this.clearFilter
                },
                /**
                 * Filters
                ...
                'AliasMapFilter combo[id=MapFilterName]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasMapFilter combo[id=MapFilterAction]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasMapFilter combo[id=columnas2]': {
                    select: this.columnSelect
                },
                'AliasMapFilter numberfield[id=value1]': {
                    keyup: this.validateValue1
                },
                'AliasMapFilter numberfield[id=valueRange1]': {
                    keyup: this.validateRange
                },
                'AliasMapFilter numberfield[id=valueRange2]': {
                    keyup: this.validateRange
                },
                'AliasMapFilter checkbox[id=allEstratos]': {
                ...
                'AliasMapFilter combo[id=MapFilterSection]': {
                    beforequery: this.autofill,
                    select: this.multiSearch
                },
                'AliasMapFilter datefield[id=MapFilterStart]': {
                    change: this.SelectFilterDateStart
                },
                'AliasMapFilter datefield[id=MapFilterEnd]': {
                    change: this.SelectFilterDateEnd
                },
                'AliasMapFilter checkbox[id=MapFilterDeleted]': {
                 ...
                 * Excel
                 */
                'AliasMapList button[action=exportXls]': {
                    click: this.exportxls
                },
                'AliasMapList button[action=MapListCreate]': {
                    click: this.exportxls
                }
            }
        );
...
//         storeConn.reload();  
    ...
    multiSearch: function () {
         ...
         * Get Store
         */
//        var store = this.getMapListStore();
//
//        /**
//         * field search
//         */
...
//        jsonObj.func = moduleConfig.serviceMapList;
//        jsonObj.filter = [];
//        
//        if (name !='') {
//            jsonObj.filter.push(
