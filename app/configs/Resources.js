...
moduleConfig.services.urlLoadModule = strURL +'/resourcedefinitions?filters={"and":[{"field":"isSystem","comparison":"eq","value":false},{"field":"id_company","comparison":"eq","value":"'+storageIdCompany+'"}]}';
...
moduleConfig.services.urlComboResourcesType = strURL +'/resourcedefinitions?filters={"and":[{"field":"isSystem","comparison":"eq","value":false},{"field":"id_company","comparison":"eq","value":"'+storageIdCompany+'"}]}';
